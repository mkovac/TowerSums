...
# Base paths
#cpp_dir="./output/stage_1_tower_sums/CE_H"
#python_dir="./python/output/Stage1_TowerSums"

cpp_dir="./output/v241217/CE_H"
...
for sector in {0..2}; do
    ...
    for board in {0..13}; do
        # Construct filenames
        file_cpp="${cpp_dir}/TowerSums_Sector_${sector}_Board_${board}_CE_H.txt"
        file_python="${python_dir}/TowerSums_Sector_${sector}_Board_${board}_CE_H.txt"
