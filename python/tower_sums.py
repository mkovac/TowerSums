...
#        fileName_CE_H_Architecture = '../input/arhitecture/v2/CE_H_' + str(i) + '_v2.vh'
        ...
        fileName_CE_E_Architecture = '../input/arhitecture/v241217/CE_E_dummy_20x30_241217.vh'
        fileName_CE_H_Architecture = '../input/arhitecture/v241217/CE_H_dummy_20x30_241217.vh'
...
#        fileName_CE_H_Inputs = '../input/energies/stage_1_unpacker/SinglePionPU0V16/CE_H/Sector_' + str(s) + '_Board_' + str(i) + '.txt'
        ...
        fileName_CE_E_Inputs = '../input/energies/v241217/Sector_' + str(s) + '_Board_' + str(i) + '_CE_E.txt'
        fileName_CE_H_Inputs = '../input/energies/v241217/Sector_' + str(s) + '_Board_' + str(i) + '_CE_H.txt'
...
#        with open(os.path.join('./output/Stage1_TowerSums/', 'TowerSums_Sector_' + str(s) + '_Board_' + str(i) + '_CE_E' + '.txt'), 'w') as f:
        with open(os.path.join('./output/v241217/', 'TowerSums_Sector_' + str(s) + '_Board_' + str(i) + '_CE_E' + '.txt'), 'w') as f:
...
#        with open(os.path.join('./output/Stage1_TowerSums/', 'TowerSums_Sector_' + str(s) + '_Board_' + str(i) + '_CE_H' + '.txt'), 'w') as f:
        with open(os.path.join('./output/v241217/', 'TowerSums_Sector_' + str(s) + '_Board_' + str(i) + '_CE_H' + '.txt'), 'w') as f:
